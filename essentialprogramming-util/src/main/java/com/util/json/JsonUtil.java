...
public class JsonUtil {
    ...
    public static Map<String, Object> fromJson(final String json) throws JsonProcessingException {
        return createObjectMapper().readValue(json, new TypeReference<>() {
        });
    }
    ...
    public Map<String, Object> fromJson(final InputStream inputStream) throws IOException {
        return createObjectMapper().readValue(inputStream, new TypeReference<>() {
        });
    }
    ...
    /**
     * Convert a java object into a byte array
     */
    public static byte[] toJsonAsBytes(final Object obj) throws JsonProcessingException {
    ...
    public static <T> Map<String, Object> map(final T object) throws JsonProcessingException {
        return createObjectMapper().convertValue(object, new TypeReference<>() {
        });
    }
